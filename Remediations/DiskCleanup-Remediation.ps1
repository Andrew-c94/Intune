...
# Global flag to control temp user data Cleanup
$global:CleanUserData = $false

# Global flag to control Recycle Bin Cleanup
$global:EmptyRecycle = $false

# Recycle Bin Retention (Days)
$global:RecycleBinRetention = 30
...
Function Get-RecycleBin {
    ...
    Param (
        ...
        $ComputerOBJ,
        [int]$RetentionTime = $RecycleBinRetention
    )
